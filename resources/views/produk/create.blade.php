...
<div class="page-header">
    <h1 class="page-title">Tambah <span>Produk</span></h1>
...
<div class="card" style="max-width:480px;">
    <div class="card-header">
        <h2><i class="fas fa-box" style="color:var(--pink); margin-right:6px;"></i> Form Produk</h2>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="NamaProduk" value="{{ old('NamaProduk') }}" required placeholder="Contoh: Boneka Beruang">
            </div>
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div class="form-group">
                    <label>Harga (Rp) <span style="color:var(--pink)">*</span></label>
                    <input type="number" name="Harga" value="{{ old('Harga') }}" min="0" required placeholder="50000">
                </div>
                <div class="form-group">
